...
// 🔐 امنیت - API Key
// ==========================================
define('API_KEY', 'YourSuperSecretKey_ChangeThis_2026!@#$%^&*');

// ==========================================
// 💳 اطلاعات کارت‌های بانکی
// کاربر گرامی فعلا تنها از بلوبانک استفاده کنید در صورتی ک حساب کاری در بلوبانک دارید اون با هم اضافه کنید
// ==========================================
